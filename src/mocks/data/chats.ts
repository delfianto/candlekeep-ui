...
export const chats: Chat[] = [
  // Aranwen the Banished - Clockwork theology crisis
  {
    ...
    character_name: "Aranwen the Banished",
    model_id: "gpt-4o",
    model_name: "GPT-4o",
    preview:
  ...
  // Lynara Frost-Scholar - Ancient ruin expedition
  {
    ...
    character_name: "Lynara Frost-Scholar",
  ...
  // Zahrasha the Death-Singer - Necromantic philosophy
  {
    ...
    character_name: "Zahrasha the Death-Singer",
  ...
  // Eloise Montclair - Poison commission for guild
  {
    ...
    character_name: "Eloise Montclair",
    model_id: "gpt-4o",
    model_name: "GPT-4o",
  ...
  // Beeps-With-The-Hist - Hist tree communion
  {
    ...
    character_name: "Beeps-With-The-Hist",
  ...
  // Hildra Stormcloak - Companion trials and beast blood
  {
    ...
    character_name: "Hildra Stormcloak",
    model_id: "gpt-4o",
    model_name: "GPT-4o",
  ...
  // Calanwe Sun-Blessed - Moral crisis over Thalmor orders
  {
    ...
    character_name: "Calanwe Sun-Blessed",
    model_id: "gpt-4o",
    model_name: "GPT-4o",
    preview:
  ...
  // Finedrin Treemother - Wild Hunt nightmares
  {
    ...
    character_name: "Finedrin Treemother",
    model_id: "gpt-4o",
    model_name: "GPT-4o",
  ...
  // Taneth at-Sentinel - Alik'r fugitive hunt
  {
    ...
    character_name: "Taneth at-Sentinel",
    model_id: "gpt-4o-mini",
    model_name: "GPT-4o Mini",
  ...
  // Yargol gra-Dushnikh - Stronghold leadership challenge
  {
    ...
    character_name: "Yargol gra-Dushnikh",
    model_id: "gpt-4o",
    model_name: "GPT-4o",
  ...
  // Valerica's Heir - Adjusting to modern Tamriel
  {
    ...
    character_name: "Valerica's Heir",
    model_id: "gpt-4o",
    model_name: "GPT-4o",
  ...
  // Lilatha of Artaeum - Temporal crisis intervention
  {
    ...
    character_name: "Lilatha of Artaeum",
    model_id: "claude-3-5-sonnet",
    model_name: "Claude 3.5 Sonnet",
  ...
  // Mirelle Shadowfoot - Thieves Guild fencing operation
  {
    ...
    character_name: "Mirelle Shadowfoot",
    model_id: "gpt-4o-mini",
    model_name: "GPT-4o Mini",
  ...
  // Helga Sky-Voice - Way of the Voice meditation
  {
    ...
    character_name: "Helga Sky-Voice",
    model_id: "gpt-4o",
    model_name: "GPT-4o",
  ...
  // Drenlyn Uvirith - Morag Tong writ execution
  {
    ...
    character_name: "Drenlyn Uvirith",
    model_id: "claude-3-5-opus",
    model_name: "Claude 3.5 Opus",
  ...
  // Aetheris Moravayn - Hermaeus Mora's servant seeks knowledge
  {
    ...
    character_name: "Aetheris Moravayn",
    model_id: "gpt-4o",
    model_name: "GPT-4o",
