  ...
  <div class="w-full text-sm">
    <div v-if="layout === 'horizontal'" class="flex items-center justify-end">
      ...
      <div
        ...
        class="flex items-center gap-3 w-77.5 max-w-full"
      >
        <Slider
      ...
      >
        <SelectTrigger class="h-8 w-50 max-w-full bg-background/50">
      ...
      <Input
        ...
        class="h-8 w-32.5 max-w-full font-mono text-right bg-background/50 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
        :model-value="modelValue ?? schema.default"
