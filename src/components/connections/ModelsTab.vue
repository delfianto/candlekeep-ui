...
<template>
  <div>
    ...
    <div class="animate-fade-in-up mb-6 flex flex-wrap items-center gap-2">
      ...
      >
        <button
          class="flex h-9 min-w-[160px] items-center gap-1.5 rounded-lg border border-[var(--border)] bg-muted/40 px-3 text-sm text-muted-foreground outline-none transition-all hover:border-muted-foreground/30"
        >
      ...
      >
        <button
          disabled
          class="flex h-9 min-w-[160px] items-center gap-1.5 rounded-lg border border-[var(--border)] bg-muted/40 px-3 text-sm text-muted-foreground/50 outline-none cursor-not-allowed"
        >
